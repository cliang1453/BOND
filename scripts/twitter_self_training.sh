...
DATA_ROOT=$PROJECT_ROOT/dataset/twitter_distant/
...
# output
OUTPUT=$PROJECT_ROOT/outputs/twitter/self_training/${MODEL_TYPE}_reinit${REINIT}_begin${BEGIN_STEP}_period${PERIOD}_${LABEL_MODE}_hp${HP_LABEL}_${EPOCH}_${LR}/
